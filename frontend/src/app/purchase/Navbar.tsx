      ...
      <div className="flex justify-between items-center p-4">
        <div className="flex space-x-4 ml-20">
          <button
            ...
            className="font-sans text-gray-800 py-2 px-4 rounded-xl hover:text-white hover:bg-amber-600 focus:outline-none transition-colors duration-200"
          >
            びあログとは？
          </button>
          <button
            onClick={handleIntroductionRedirect}
            className="font-sans text-gray-800 py-2 px-4 rounded-xl hover:text-white hover:bg-amber-600 focus:outline-none transition-colors duration-200"
          >
            クラフトビール入門
          </button>
          <button
            onClick={handleColumnRedirect}
            className="font-sans text-gray-800 py-2 px-4 rounded-xl hover:text-white hover:bg-amber-600 focus:outline-none transition-colors duration-200"
          >
            ビールコラム
          </button>
          <button
            onClick={handlePickupPubRedirect}
            className="font-sans text-gray-800 py-2 px-4 rounded-xl hover:text-white hover:bg-amber-600 focus:outline-none transition-colors duration-200"
          >
            ピックアップ居酒屋
          </button>
        ...
        <div className="flex space-x-4 mr-20">
          <Link href="/user" legacyBehavior>
            <a className="bg-amber-600 text-white py-2 px-4 rounded-xl hover:bg-amber-700 focus:outline-none transition-colors duration-200">
              マイページ
            </a>
          </Link>
          <button
