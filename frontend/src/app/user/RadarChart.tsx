...
const RadarChart: React.FC<RadarChartProps> = ({ preferences, onPreferenceChange, style }) => {
  ...
  return (
    <div className="relative w-96 h-96" style={style}> {/* サイズを大きくする */}
        ...
        return (
          ...
          >
            <div className="flex flex-col items-center">
              <label className="text-xs mb-1" style={{ whiteSpace: 'nowrap' }}>{preference.item.item_name}</label> {/* item_name を直接使用 */}
              <select
